...
import com.volley.air.R;

import com.volley.air.error.VolleyError;
import com.volley.air.misc.Utils.HorizontallyScrollable;
import com.volley.air.toolbox.ImageLoader.ImageContainer;
import com.volley.air.toolbox.ImageLoader.ImageListener;
...
public class PhotoView extends NetworkImageView implements OnGestureListener,
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (mFixedHeight != -1) {
            super.onMeasure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec(mFixedHeight,
